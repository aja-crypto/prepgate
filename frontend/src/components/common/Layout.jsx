...
const NAV = [
  ...
  { section: 'Study' },
  { label: 'Learning Hub', icon: 'resources', to: '/learning-hub' },
...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-bg overflow-hidden">
      ...
      <aside className={`
        fixed md:relative z-50 md:z-auto h-full w-[240px] glass-sidebar flex flex-col
      ...
      <main className="flex-1 overflow-y-auto flex flex-col min-w-0">
        <header className="sticky top-0 z-30 flex items-center gap-3 px-4 md:px-6 py-3 border-b border-border glass-sidebar">
          ...
          <button
            ...
            className="flex-1 max-w-md flex items-center gap-2.5 rounded-xl border border-border bg-bg-2/60 backdrop-blur-sm px-4 py-2.5 text-left hover:border-primary/25 transition-all"
          >
            <Icon name="search" className="text-text3" />
            <span className="text-xs text-text3 flex-1">Search topics, notes, PYQs...</span>
        ...
        <div className="p-4 md:p-6 lg:p-8 animate-fade-in flex-1 max-w-[1400px] w-full mx-auto">
          <Outlet />
        </div>
      </main>
