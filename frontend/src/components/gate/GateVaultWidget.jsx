...
export default function GateVaultWidget() {
  ...
  return (
    <GlassCard>
      ...
      <div className="flex gap-1 mb-4 overflow-x-auto pb-1 scrollbar-none -mx-1 px-1">
        {CHALLENGE_TABS.map(t => (
          <button key={t.id} onClick={() => setTab(t.id)}
            className={`flex items-center gap-1.5 text-[10px] px-2.5 py-1.5 rounded-lg whitespace-nowrap transition-all font-medium shrink-0 ${
              tab === t.id
