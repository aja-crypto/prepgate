...
/**
 * Premium GateNexa AI Brand Icon - AI Robot Mind Animation
 ...
 */
const GateNexaAIIcon = ({ size = 32, thinking = false, listening = false, notification = false, className = '' }) => {
  return (
    <div
