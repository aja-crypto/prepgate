...
const icons = {
  dashboard: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
      <path d="M3 4a1 1 0 011-1h3a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm9-1h3a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1V4a1 1 0 011-1zm-9 9a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1v-3zm9-1h3a1 1 0 011 1v5a1 1 0 01-1 1h-3a1 1 0 01-1-1v-5a1 1 0 011-1z" />
    </svg>
  ),
  analytics: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
  ...
  subjects: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
      <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10.394C3.057 14.838 4.163 14.5 5.5 14.5c1.256 0 2.443.29 3.5.804V4.804zM14.5 4c-1.255 0-2.443.29-3.5.804v10.394c1.057-.453 2.163-.804 3.5-.804 1.256 0 2.443.29 3.5.804V4.804A7.968 7.968 0 0014.5 4z" />
    </svg>
  ),
  topics: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
  ...
  formulas: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
      <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3 4a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm2 4a1 1 0 100 2h2a1 1 0 100-2H8z" clipRule="evenodd" />
    </svg>
  ),
  resources: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
      <path fillRule="evenodd" d="M12.586 4.586A2 2 0 1115 7l-6 6a2 2 0 01-2.828 0l-1.586-1.586a2 2 0 010-2.828l6-6z" clipRule="evenodd" />
      <path d="M5 14a1 1 0 011-1h2a1 1 0 110 2H6a1 1 0 01-1-1z" />
    </svg>
  ),
  notes: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-[18px] h-[18px]">
