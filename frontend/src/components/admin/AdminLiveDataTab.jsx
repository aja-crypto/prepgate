...
export default function AdminLiveDataTab() {
  ...
  useEffect(() => { mountedRef.current = true; loadData(); return () => { mountedRef.current = false; }; }, [filter]);
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={handlePublishAll} disabled={publishingAll} className="text-xs bg-green-500/10 text-green-400 px-3 py-1.5 rounded-lg border border-green-500/20 disabled:opacity-50">
          {publishingAll ? 'Publishing...' : '✓ Publish All Verified'}
        </button>
