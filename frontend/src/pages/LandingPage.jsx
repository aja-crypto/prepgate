...
export default function LandingPage() {
  ...
  useEffect(() => {
    const onScroll = throttle(() => setNavScrolled(window.scrollY > 60), 100);
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {user ? (
              <>
                ...
                <Link to="/platform" className="relative text-[10px] font-medium transition-all duration-300 hover:-translate-y-0.5 hidden sm:inline-block group" style={{ color: '#22D3EE' }}>
                  <span className="group-hover:text-white transition-colors">Platform</span>
                  <span className="absolute bottom-0 left-0 w-0 h-px group-hover:w-full transition-all duration-300" style={{ background: 'linear-gradient(90deg, #22D3EE, #8B5CF6)' }} />
                </Link>
