...
const GATE_SUBJECTS = [
  { code: 'APT', name: 'Aptitude', color: '#f59e0b', icon: '≡ƒº«', mandatory: true },
  { code: 'DS', name: 'Data Structures', color: '#10b981', icon: '≡ƒôè' },
  { code: 'DBMS', name: 'Database Systems', color: '#6366f1', icon: '≡ƒùä' },
  { code: 'OS', name: 'Operating Systems', color: '#8b5cf6', icon: 'ΓÜÖ∩╕Å' },
  { code: 'CN', name: 'Computer Networks', color: '#06b6d4', icon: '≡ƒîÉ' },
  { code: 'CO', name: 'Computer Organization', color: '#ec4899', icon: '≡ƒûÑ' },
  { code: 'TOC', name: 'Theory of Computation', color: '#f97316', icon: '≡ƒñû' },
  { code: 'CD', name: 'Compiler Design', color: '#14b8a6', icon: '≡ƒöº' },
  { code: 'AL', name: 'Algorithms', color: '#ef4444', icon: 'ΓÜí' },
];
...
const DEMO_QUESTIONS = [
  ...
  { _id: 'q7', index: 6, question: 'What is the integral Γê½1 dx?', options: ['1', 'x', 'x + C', '0'], correctAnswer: 2, explanation: 'Γê½1 dx = x + C, where C is the constant of integration', subject: 'MA', topic: 'Calculus - Integration', difficulty: 'easy', importanceScore: 9 },
  ...
  { _id: 'q9', index: 8, question: 'What is the rank of an n├ùn identity matrix?', options: ['0', '1', 'n-1', 'n'], correctAnswer: 3, explanation: 'The rank of an n├ùn identity matrix is n (full rank, all rows/columns are linearly independent)', subject: 'MA', topic: 'Linear Algebra - Rank', difficulty: 'medium', importanceScore: 6 },
  ...
  { _id: 'q12', index: 11, question: 'What is 5! (5 factorial)?', options: ['20', '60', '120', '240'], correctAnswer: 2, explanation: '5! = 5 ├ù 4 ├ù 3 ├ù 2 ├ù 1 = 120', subject: 'DS', topic: 'Combinatorics', difficulty: 'easy', importanceScore: 9 },
  ...
  if (!monthlySet) {
    return (
      <div className="text-center py-16 px-4">
        <div className="w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center text-4xl" style={{ background: 'linear-gradient(135deg, rgba(168,85,247,0.2), rgba(99,102,241,0.1))', border: '1px solid rgba(168,85,247,0.3)' }}>≡ƒöÑ</div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-4 md:py-6">
      ...
      <div className="text-center mb-6 md:mb-8">
        ...
        <p className="text-text3">{monthlySet.monthName} {monthlySet.year} ΓÇó {monthlySet.questions?.length || 50} Questions</p>
      </div>
