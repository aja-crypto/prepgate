...
console.log('PlatformPage LOADED v3');
...
const SECTIONS = [
  ...
  { n: 11, title: 'Resource Hub', desc: 'Everything you need in one place — notes, formula sheets, short notes, PDFs, videos, and important resources.', bullets: ['Notes & Short Notes', 'Formula Sheets & PDFs', 'Video Resources & Tutorials', 'Bookmarks & Downloads'], imageSrc: '/assets/explore/resources.png', imageLabel: 'Resources', link: '/subjects' },
];
