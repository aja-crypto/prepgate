...
const FEATURE_CARDS = [
  { icon: Brain, title: 'GateNexa AI', sub: 'AI-Powered Personal Mentor', desc: 'AI that understands your weak areas, recommends daily tasks, solves doubts instantly, and creates personalized study plans.', color: '#8B5CF6', gradient: 'linear-gradient(135deg, rgba(139,92,246,0.15), rgba(139,92,246,0.02))' },
