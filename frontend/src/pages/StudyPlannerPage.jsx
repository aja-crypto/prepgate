...
export default function StudyPlannerPage() {
  ...
  const generateAiPlan = async () => {
    try {
      ...
      const { plan, source } = res.data?.data || {};
      setAiPlan(plan || []);
      setShowAiPlan(true);
      if (source === 'gpt') toast.success('GPT study plan generated');
      else toast('Heuristic plan generated (add OPENAI_API_KEY for GPT)', { icon: '🤖' });
    } catch {
