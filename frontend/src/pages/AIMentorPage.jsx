            ...
            <div className="space-y-4">
              {loading ? (
                ...
                <div className="bg-surface border border-border rounded-xl p-6 text-center">
                  <p className="text-sm text-text2">No recommendations right now. Complete a few topics to get personalized guidance.</p>
                  <button onClick={() => window.location.reload()} className="mt-3 text-xs text-primary hover:underline">Refresh</button>
                </div>
              )}
            </div>
          </section>
