...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    authService.verifyEmail(token)
      .then((res) => { if (mountedRef.current) { setStatus('success'); setMessage(res.data.message); } })
      .catch((err) => { if (mountedRef.current) { setStatus('error'); setMessage(getApiErrorMessage(err, 'Verification failed')); } });
