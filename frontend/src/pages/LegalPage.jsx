...
const PAGES = {
  'privacy-policy': {
    ...
    sections: [
      ...
      { h: 'AI Usage', c: 'AI chat conversations are processed to generate responses. Conversations may be stored to improve response quality. To request removal of conversation history, contact support@gatenexa.app.' },
      { h: 'Storage & Cookies', c: 'GateNexa uses browser localStorage to store authentication tokens, theme preferences, and dashboard layout choices. This is different from cookies — localStorage data stays on your device and is not sent to third parties. GateNexa does not use analytics cookies or advertising cookies. See our Cookie Policy for details.' },
      { h: 'Data Retention', c: 'Your data is retained for as long as your account is active. You can request account deletion at any time from Settings. Account deletion is scheduled and recoverable for 30 days. Password verification is required for local accounts. For questions about data handling, contact privacy@gatenexa.app.' },
      { h: 'Your Rights', c: 'You have the right to access, correct, or delete your personal data. You can export your study progress, topics, notes, PYQs, and mock test data from Settings as CSV or Excel. For privacy-related requests, contact privacy@gatenexa.app.' },
      { h: 'Third-Party Services', c: 'GateNexa AI (also referred to as Nexa AI) is GateNexa\'s built-in AI assistant feature. AI functionality may rely on third-party AI service providers to generate responses. We also use MongoDB for database storage and Cloudinary for file storage. Each provider has its own privacy policy governing data handling.' },
    ],
  },
  'terms-of-service': {
    ...
    sections: [
      ...
      { h: 'Termination', c: 'We reserve the right to terminate accounts that violate these terms. Users may delete their account at any time from Settings. Account deletion is scheduled and recoverable for 30 days. Password verification is required for local accounts.' },
    ],
  },
  'cookie-policy': {
    title: 'Cookie Policy',
    ...
    sections: [
      ...
      { h: 'Authentication & Session Storage', c: 'GateNexa uses JWT tokens stored in your browser\'s localStorage to keep you logged in across sessions. These tokens expire after a set period and are automatically refreshed. localStorage is a browser storage mechanism separate from cookies — data stored there is not accessible to other websites.' },
      { h: 'Preference Storage', c: 'Your settings — dark/light theme, accent color, dashboard layout, and AI assistant preferences — are stored in your browser\'s localStorage. This is different from preference cookies. localStorage data remains on your device and is not transmitted to GateNexa servers.' },
      { h: 'Analytics', c: 'GateNexa does not use analytics cookies or third-party analytics tracking tools. We do not set cookies to track your browsing behavior across websites.' },
      { h: 'Managing Your Data', c: 'Some settings are stored locally in your browser. Clearing your browser\'s site data may remove these settings and log you out. Server-side account data (profile, study progress, AI conversations) is stored on GateNexa servers and can be managed from your Settings page or by contacting support@gatenexa.app.' },
    ],
  },
  'disclaimer': {
    title: 'Disclaimer',
